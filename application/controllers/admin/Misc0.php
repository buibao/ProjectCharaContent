...

{
    ...
    public function content_subject_exists()

    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if ($this->input->post()) {
                ...
                // First we need to check if the subject is the same
                ...
                if ($id != '') {
                    ...
                    $_current_email = $this->db->get('tblcontents')->row();

                    if ($_current_email->email == $this->input->post('subject')) {
                ...
                $total_rows = $this->db->count_all_results('tblcontents');
