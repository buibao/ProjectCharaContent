    ...
    public function project($id = '')
    {
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
                ...
                {
                $user_access_token  = "EAAJGSplFaE0BAN3frGMqZBZAu96mdKxhHESKykf4RSnkLKJvEoXjGcIoLzZCZAvJP34uod9lymPrHkgvgVqOV0d5ZB3auMSd1Onbf2R4f65pvY4ZAUXHvNeJZCDf6zcycNHBeFTw9NmXDC7NC3R2pZBrOqGcgmW93r3M0UGuZA6u1QgZDZD";
              ...
              if ($id) {
                ...
                if(!empty($data['link_page']))
                {
                $user_access_token  = "EAAJGSplFaE0BANAFy8TcswZABjonV8zZB8YQKoeVcYlOoylsLRLksesNsfqFBNDPm7FcRAnL4P7tyLAlA6Ac61saJGnvE42ncJZB75ZBz3ZBVZCl6j3JtymQ9CfZALMgtkPiJ4a1fWGhftLXhdqq1DV4NngO3yVNSYZD";
                $urlPage            = $data['link_page'];
                $access_tokenStr = '';
                    if($urlPage[-1] == '/')
                    {
