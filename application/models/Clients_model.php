...
class Clients_model extends CRM_Model
{
    ...
    public function add($data, $client_or_lead_convert_request = false)
    {
        ...
        // FIX SOURCE lv_fields_in
        if (isset($data['lv_fields_in'])) {
            $fields_in = $data['lv_fields_in'];
            unset($data['lv_fields_in']);
        }
    ...
    public function update($data, $id, $client_request = false)
    {
        ...
        if ($this->client_groups_model->sync_customer_fields($id, $fields_in)) {
            $affectedRows++;
        }
    ...
    {
        return $this->client_groups_model->get_customer_fields($id);
    }
    ...
    {
        return $this->client_groups_model->get_fields($id);
    }
    ...
    {
        return $this->client_groups_model->deletefield($id);
    }
    ...
    {
        return $this->client_groups_model->addfield($data);
    }
    ...
    {
        return $this->client_groups_model->editfield($data);
    }
