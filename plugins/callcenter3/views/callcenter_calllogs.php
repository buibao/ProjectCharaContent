...
<h4>Tổng số cuộc gọi: <?php echo $results->total; ?> </h5>
  ...
  <ul class="pagination justify-content-center">
    ...
    for($i =1; $i <= $pages; $i++){
    	if($ids==$i){
echo "<li class='page-item'><a class='page-link' style='background-color:red' href='".base_url()."/admin/callcenter/calllog/".$i."''>".$i."</a></li>";
    	}else{
echo "<li class='page-item'><a class='page-link'  href='".base_url()."/admin/callcenter/calllog/".$i."''>".$i."</a></li>";
    ...
    <li class="page-item">
     ...
     <?php echo "<a class="."'page-link'" ."href=''>Next</a>" ?>
