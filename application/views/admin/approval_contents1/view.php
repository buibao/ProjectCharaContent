        ...
        <div class="row">
            <div class="col-md-8">
               ...
               <nav aria-label="breadcrumb">
                 <ol class="breadcrumb">
                   <li class="breadcrumb-item"><a href="<?php echo admin_url('approval_contents'); ?>"><?php echo _l('approval_content'); ?> </a></li>
...
?></td>
                     ...
                     <div class="clearfix">
                        ...
                        <div class=" ft 1">
                           <?php echo form_open(); ?>
                        <button class="btn-tr btn btn-info" id="sendtocustomer">
                      ...
                      <?php echo form_close(); ?>
                        ...
                        <div class="ft q">
                              <?php echo form_open(); ?>
                           <button type="submit" class="btn btn-default "><?php echo _l('rewrite'); ?></button>
                              </button>
