...
if (file_exists(APPPATH.'config/app-config.php')) {
    ...
    echo '<h1>CharaContent Management System not installed</h1>';

    echo '<p>1. To you use the automatic CharaContent Management System installation tool click <a href="'.$install_url.'">here ('.$install_url.')</a></p>';
