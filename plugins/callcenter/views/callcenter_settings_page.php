...
<h4>Token</h4>
<?php echo form_textarea(['name'=>'Token','placeholder'=>'Token','class'=>'form-control','value'=>set_value('Token',$users->Token),'style'=>'width:40%;height: 110px;']);?>
<?php echo form_error('Token','<div class="text-danger',
'</div>');?>
