...
//                                                     dataType: 'json',
                                                    ...
                                                    success: function (response) {
                                                        ...
                                                        //     window.location.href = "/account/logout";
                                                        // }
                                                        var phoneCalls = response.data.calls;
                                                        var page = response.data.currentPage;
                                                        var totalPage = response.data.totalPages;
                                                        var totalCount = response.data.totalCalls;
...
//                  console.log(posX);
                                            ...
                                            function loopDataCall(dataResponse) {
                                                ...
                                                $.each(dataResponse, function (key, value) {
                                                    if (dataResponse[key].from_internal == 1 && dataResponse[key].to_internal == 1) {
                                                        type = "<img src='https://developer.stringee.com/static/assets/images/icon-in2in.png' class='icon-call' />";
                                                    } else if (dataResponse[key].from_internal == 1 && dataResponse[key].to_internal == 0) {
                                                        type = "<img src='https://developer.stringee.com/static/assets/images/icon-in2ex.png' class='icon-call' />";
                                                    } else if (dataResponse[key].from_internal == 0 && dataResponse[key].to_internal == 1) {
                                                        type = "<img src='https://developer.stringee.com/static/assets/images/icon-ex2in.png' class='icon-call' />";
                                                    } else if (dataResponse[key].from_internal == 0 && dataResponse[key].to_internal == 0) {
                                                        type = "<img src='https://developer.stringee.com/static/assets/images/icon-ex2ex.png' class='icon-call' />";
                                                    }
                                                    ...
                                                    if (Boolean(dataResponse[key].recorded)) {
                                                        btn_download = "<a href='https://developer.stringee.com/call/recording/projectId/" + dataResponse[key].project_id + "/callId/" + dataResponse[key].id + "'" +
                                                                "class='btn btn-danger btn-xs text-white btnDownload' onclick='checkSession()'>Download</a>";
                                                    }

                                                    data += "<tr>" +
                                                            "<td>" + dataResponse[key].id + "</td>" +
                                                            "<td class='projectName'>" + dataResponse[key].project_name + "</td>" +
                                                            "<td class='userID'>" + dataResponse[key].from_user_id + "</td>" +
                                                            "<td class='fromNumber'>" + dataResponse[key].from_number + "</td>" +
                                                            "<td class='toNumber'>" + dataResponse[key].to_number + "</td>" +
                                                            "<td>" + type + "</td>" +
                                                            // "<td>" + dataResponse[key].answer_duration_minutes + "</td>" +
                                                            "<td>" + (dataResponse[key].video_call ? "<img src='/static/assets/images/icon16/video-camera.png'>" : "<span style='color:#adadad'>No</span>") + "</td>" +
                                                            "<td>" + "$" + dataResponse[key].amount + "</td>" +
                                                            "<td>" + btn_download + "</td>" +
                                                            "<td class='startTime'>" + dataResponse[key].start_time_datetime + "</td>" +
                                                            // "<td class='answerTime'>" + answer_time + "</td>" +
                                                            "<td class='stopTime'>" + dataResponse[key].stop_time_datetime + "</td>" +
                                                            "</tr>";
                                                });
                                                return data;
                                            }
