...
<head>
  ...
  <title>Chara Content MS - Installation</title>
     ...
     <div class="container">
      <div class="row">
       ...
       <div class="col-md-8 col-md-offset-2">
        <div class="logo">
          <img src="https://characontent.com/wp-content/uploads/2018/09/logoChara.png">
        </div>
...
<?php } ?>
<p>Please login as administrator at <a href="<?php echo $_POST['base_url']; ?>admin" target="_blank"><?php echo $_POST['base_url']; ?>admin</a></p>
<!-- <p>You can lick here to delete the install directory <span><button type="button" class="btn btn-danger" id="btnDelete">Delete</button></span></p>
 -->
<hr />
<p><b>Remember:</b></p>
