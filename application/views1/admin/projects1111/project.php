        ...
        <div class="row">
			...
			<!-- breadcrumb -->
               <nav aria-label="breadcrumb">
                 <ol class="breadcrumb">
                   <li class="breadcrumb-item"><a href="<?php echo admin_url('projects'); ?>"><?php echo _l('projects'); ?> </a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <?php $value = (isset($project) ? $project->link_web : ''); ?>
                        <?php echo render_input('link_web','project_link_web',$value); ?>
                    </div>
                    <!--Types-->
                     <div class="col-md-12">
                     <?php
                     $selected = (isset($project) ? $project->project_type : '');
                     if(is_admin() || get_option('staff_members_create_inline_contract_types') == '1'){
                      echo render_select_with_input_group('project_type',$types,array('id','name'),'project_type',$selected,'<a href="#" onclick="new_type();return false;"><i class="fa fa-plus"></i></a>');
                     } else {
                     echo render_select('project_type',$types,array('id','name'),'project_type',$selected);
                     }
                     ?>
                 </div>
                </div>
...
<?php init_tail(); ?>
<?php $this->load->view('admin/projects/project_type'); ?>
