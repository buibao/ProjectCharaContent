...
<p>You can lick here to delete the install directory</p><span><button type="button" class="btn btn-danger" id="btnDelete">Delete</button></span>
...
alert("helo");
// <?php 
//  if (@rename('../install','../install_old') == true) {
