            ...
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <div class="btn-bottom-toolbar text-right">
                     <?php if(($contract->contract_status) != 2){ ?>
                        
                     

                <button class="btn-tr btn btn-info " id="save_and_send">
                  <?php echo _l('submitcontract'); ?>
                </button>
                <button class="btn-tr btn btn-info">
                  <?php echo _l('draftcontract'); ?>
                </button>
             <?php }?>
                  </div>
                  <?php echo form_close(); ?>
...
<!--Checked checkbox when click send and save button-->
<script type="text/javascript">
   function check() {

  var inputs = document.querySelector('#not_visible_to_client');
