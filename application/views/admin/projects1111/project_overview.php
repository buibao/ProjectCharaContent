   ...
   <div class="col-md-6 border-right project-overview-left">
      ...
      <div class="col-md-7">
         ...
         <tr class="project-overview">
          ...
          <td>
          <a href="<?php echo ($project->link_page); ?>"><?php echo ($project->link_page); ?></a>
          </td>
          </tr>
          <tr class="project-overview">
          <td class="bold"><?php echo _l('project_link_web'); ?></td>
          <td>
          <a href="<?php echo ($project->link_web); ?>"><?php echo ($project->link_web); ?></a>
          </td>
          </tr>
