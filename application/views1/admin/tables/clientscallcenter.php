...
foreach ($rResult as $aRow) {
    ...
    $row[] = ($aRow['phonenumber'] ? "<a id='btnToolCall' onclick=makeCalls('".$aRow['phonenumber']."')  style='cursor: pointer'>" . $aRow['phonenumber'] . '</a>' : '');
    // onclick=testMakeCall('".$aRow['phonenumber']."')
    //onclick=testMakeCall('".$aRow['phonenumber']."')
    ...
    $row[] = "<button  id='hangupBtn' onclick=testHangupCall()>Hangup</button>";
