...
<div id="wrapper">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<?php echo admin_url('tickets'); ?>"><?php echo _l('clients_nav_support'); ?></a></li>
    <li class="breadcrumb-item active" aria-current="page"><?php echo _l('new_ticket')?></li>
  </ol>
</nav>
