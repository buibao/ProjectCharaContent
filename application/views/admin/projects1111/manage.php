              ...
              <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
                ...
                <ul class="dropdown-menu dropdown-menu-right width300">
                  ...
                  <?php foreach($statuses as $status){ ?>
                    ...
                    <?php } ?>
                    <!--Display Infor Line in Filter Modal-->
                    <li class="divider"></li>
                    <?php if(count($project_types) > 0){ ?>
                    <?php foreach($project_types as $type){ ?>
                      <li>
                      <a href="#" data-cview="projects_by_type_<?php echo $type['id']; ?>" onclick="dt_custom_view('projects_by_type_<?php echo $type['id']; ?>','.table-projects','projects_by_type_<?php echo $type['id']; ?>'); return false;">
                      <?php echo $type['name']; ?>
                      </a>
                      </li>
                      <?php } ?>
               ...
               <div class="row mbot15">
                ...
                <div class="_filters _hidden_inputs">
                  ...
                  foreach($project_types as $type){
                    echo form_hidden('projects_by_type_'.$type['id']);
                  }
