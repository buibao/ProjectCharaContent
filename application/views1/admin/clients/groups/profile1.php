         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <?php// echo render_input( 'business', 'client_linebusiness',$value); ?> -->
                     <!--  -->
                  <?php $value=( isset($client) ? $client->phonenumber : ''); ?>
                  <?php echo render_input( 'phonenumber', 'client_phonenumber',$value); ?>
				   <!-- FIX SOURCE -->
                    <?php $value=( isset($client) ? $client->facebook : ''); ?>
                  <?php echo render_input( 'facebook', 'client_facebook',$value); ?>
                  <!--  -->
              ...
              <?php 
                     ...
                     if(isset($customer_fields)){
                       foreach($customer_fields as $field){
                          array_push($selected,$field['fieldid']);
                           

                       }

                     }
                     if(is_admin() || get_option('staff_members_create_inline_customer_fields') == '1'){
                      echo render_select_with_input_group('lv_fields_in[]',$lv_fields,array('id','name'),'customer_fields',$selected,'<a href="#" data-toggle="modal" data-target="#customer_field_modal"><i class="fa fa-plus"></i></a>',array('multiple'=>true,'data-actions-box'=>true),array(),'','',false);
                      } else {
                        echo render_select('lv_fields_in[]',$lv_fields,array('id','name'),'customer_fields',$selected,array('multiple'=>true,'data-actions-box'=>true),array(),'','',false);
                      }
                     ?>
                <!--  -->
