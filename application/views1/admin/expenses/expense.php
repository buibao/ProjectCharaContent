...
<div id="wrapper">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<?php echo admin_url('expenses'); ?>"><?php echo _l('client_expenses_tab'); ?></a></li>
    <li class="breadcrumb-item active" aria-current="page"><?php echo _l('new_expense')?></li>
  </ol>
</nav>
      <div class="row">
         <?php
