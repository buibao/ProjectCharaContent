...
<div id="wrapper">
                ...
                <div class="panel-body _buttons">
                    ...
                    <div class="panel_s">
                        ...
                        <div class="panel-body">
                           <?php $this->load->view('admin/callcenter/table_html'); ?>
                       </div>
                   </div>
               </div>
           </div>
   ...
   <script>
    $(function(){
        ...
        initDataTable('.table-contracts', admin_url+'callcenter/table', undefined, undefined, ContractsServerParams,<?php echo do_action('contracts_table_default_order',json_encode(array(6,'asc'))); ?>);
