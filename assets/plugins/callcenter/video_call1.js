...
var client;
var fromNumber = 'VPBX_CTTT_100';
var call;

$(document).ready(function () {
	//check isWebRTCSupported
        console.log('StringeeUtil.isWebRTCSupported: ' + StringeeUtil.isWebRTCSupported() + ' in VideoCall' );
	...
	client.on('connect', function () {
		console.log('++++++++++++++ connected to StringeeServer VideoCall');
	});
