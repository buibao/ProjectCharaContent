...
<head>
    ...
    <script type="text/javascript" src="https://static.stringee.com/web_phone/lastest/js/all-js-1.0.0.js"></script>
</head>
        ...
        <div id="app">
            ...
            <section id="page-contact" class="page display-none">
                <div class="wrap-contact-filter p-l-r-20 mb-20 display-table">
                    <div class="contact-filter display-flex font-size-12">
                        <button class="contact-filter-item active p-5 p-l-r-10 mr-10 mt-5 border-none">Tất cả</button>
            ...
            <section class="wrap-toolbar-bottom position-absolute bottom-0 height-100 width-100-percent box-shadow2 z-index-100 bg-white">
                <div class="wrap-toolbar text-center display-flex justify-content-space-evenly">
                    <button id="btnToolActivity" class="toolbar-item display-table-cell border-none bg-transparent"> <img src="https://static.stringee.com/web_phone/lastest/images/icon-list-gray.svg" class="icon-gray" /> <img src="https://static.stringee.com/web_phone/lastest/images/icon-list.svg" class="icon" /> </button>
                    ...
                    <button id="btnToolContact" class="toolbar-item display-table-cell border-none bg-transparent"> <img src="https://static.stringee.com/web_phone/lastest/images/icon-user-gray.svg" class="icon-gray" /> <img src="https://static.stringee.com/web_phone/lastest/images/icon-user.svg" class="icon" /> </button>
